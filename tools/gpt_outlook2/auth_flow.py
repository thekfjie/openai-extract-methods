...
from integrations.oai_fingerprint import fingerprint_http_headers
...
class AuthFlow:
    ...
    def __init__(self, config: Config, sms_callback: Optional[Any] = None):
        ...
        self._fingerprint_headers = fingerprint_http_headers(self._fingerprint)
        self._impersonate_candidates = list(
            self._fingerprint.get("impersonate_candidates")
            or [self._fingerprint["impersonate"], "safari17_0", "safari15_5"]
        )
        ...
        self.session = create_http_session(
            ...
            user_agent=self._ua,
            default_headers=self._fingerprint_headers,
        )
    ...
    def _common_headers(self, referer: str = "https://chatgpt.com/") -> dict:
        ...
        headers = dict(self._fingerprint_headers)
        headers.update({
            "Accept": "application/json",
            "Referer": referer,
            "Origin": origin,
