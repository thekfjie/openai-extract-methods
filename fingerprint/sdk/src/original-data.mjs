// Generated from RoxyBrowser 3.9.2 sourcesContent[76].
// Run scripts/extract-original-catalogs.mjs to reproduce this file.

export const ORIGINAL_KNOWN_FONTS = [
  "Andale Mono",
  "Arial",
  "Arial Black",
  "Arial Hebrew",
...
export const ORIGINAL_WINDOWS_CORE_FONTS = [
  "Arial",
  "Calibri",
  "Cambria Math",
  "Cambria",
...
export const ORIGINAL_ALLOW_FONTS = [
  "Andale Mono",
  "Arial",
  "Arial Black",
  "Arial Hebrew",
...
export const ORIGINAL_CHROME_VOICES = [
  {
...
export const ORIGINAL_FIREFOX_VOICES = [
  {
  ...
  {
    "name": "Microsoft Laura - Spanish (Mexico)",
    "lang": "es-MX",
    "isLocalService": true
  },
  {
  ...
  {
    "name": "Microsoft Lili - Dutch (Netherlands)",
    "lang": "nl-NL",
    "isLocalService": true
  },
  {
  ...
  {
    "name": "Microsoft Tracy - Chinese (Traditional, Taiwan)",
    "lang": "zh-TW",
    "isLocalService": true
  },
  {
    "name": "Microsoft Danny - Chinese (Traditional, Taiwan)",
    "lang": "zh-TW",
    "isLocalService": true
  },
  {
